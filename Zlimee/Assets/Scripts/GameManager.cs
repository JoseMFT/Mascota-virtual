...
public class GameManager: MonoBehaviour {
    ...
    void Update () {
        ...
        if (prevLovePoints > lovePoints) {
            ...
            if (lovePoints == 60 || lovePoints == 20 || lovePoints == 5) {
                if (lovePoints == 60) {
                    prevSkin = skinQueen;
                    activeSkin = skinSenior;
    ...
    public void ClickedExit () {
        ...
        emptySlime.transform.rotation = Quaternion.Euler (Vector3.zero);
        emptySlime.transform.localScale = ogSize;
